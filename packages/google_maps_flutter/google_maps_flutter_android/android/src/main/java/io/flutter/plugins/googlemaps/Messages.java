...
public class Messages {
   ...
   * Generated class from Pigeon that represents data sent in messages.
   */
  public static final class PlatformIntPair {
    ...
    public boolean equals(Object o) {
      if (this == o) { return true; }
      if (o == null || getClass() != o.getClass()) { return false; }
      PlatformIntPair that = (PlatformIntPair) o;
      return x.equals(that.x) && y.equals(that.y);
    }
    ...
    public static final class Builder {
      ...
      public @NonNull PlatformIntPair build() {
        PlatformIntPair pigeonReturn = new PlatformIntPair();
        pigeonReturn.setX(x);
        pigeonReturn.setY(y);
        return pigeonReturn;
      }
    ...
    static @NonNull PlatformIntPair fromList(@NonNull ArrayList<Object> pigeonVar_list) {
      PlatformIntPair pigeonResult = new PlatformIntPair();
      Object x = pigeonVar_list.get(0);
  ...
  public static final class PlatformPolyline {
     ...
     */
    private @Nullable PlatformIntPair gradient;

    public @Nullable PlatformIntPair getGradient() {
      return gradient;
    }

    public void setGradient(@Nullable PlatformIntPair setterArg) {
      this.gradient = setterArg;
    }

    /** The texture image data for the polyline. */
    private @Nullable PlatformBitmap texture;

    public @Nullable PlatformBitmap getTexture() {
      return texture;
    }

    public void setTexture(@Nullable PlatformBitmap setterArg) {
      this.texture = setterArg;
    }
    ...
    public boolean equals(Object o) {
      ...
      return polylineId.equals(that.polylineId) && consumesTapEvents.equals(that.consumesTapEvents) && color.equals(that.color) && geodesic.equals(that.geodesic) && jointType.equals(that.jointType) && patterns.equals(that.patterns) && points.equals(that.points) && startCap.equals(that.startCap) && endCap.equals(that.endCap) && visible.equals(that.visible) && width.equals(that.width) && zIndex.equals(that.zIndex) && Objects.equals(gradient, that.gradient) && Objects.equals(texture, that.texture);
    }

    @Override
    public int hashCode() {
      return Objects.hash(polylineId, consumesTapEvents, color, geodesic, jointType, patterns, points, startCap, endCap, visible, width, zIndex, gradient, texture);
    }
    ...
    public static final class Builder {
      ...
      @CanIgnoreReturnValue
      public @NonNull Builder setGradient(@Nullable PlatformIntPair setterArg) {
        this.gradient = setterArg;
        return this;
      }
      ...
      @CanIgnoreReturnValue
      public @NonNull Builder setTexture(@Nullable PlatformBitmap setterArg) {
        this.texture = setterArg;
        return this;
      }
      ...
      public @NonNull PlatformPolyline build() {
        ...
        pigeonReturn.setTexture(texture);
        return pigeonReturn;
      }
    }
    ...
    static @NonNull PlatformPolyline fromList(@NonNull ArrayList<Object> pigeonVar_list) {
      ...
      pigeonResult.setGradient((PlatformIntPair) gradient);
      Object texture = pigeonVar_list.get(13);
      pigeonResult.setTexture((PlatformBitmap) texture);
      return pigeonResult;
    }
  }
  ...
  private static class PigeonCodec extends StandardMessageCodec {
    ...
    protected Object readValueOfType(byte type, @NonNull ByteBuffer buffer) {
      switch (type) {
        ...
        case (byte) 149:
          return PlatformIntPair.fromList((ArrayList<Object>) readValue(buffer));
        case (byte) 150:
    ...
    protected void writeValue(@NonNull ByteArrayOutputStream stream, Object value) {
      ...
      } else if (value instanceof PlatformIntPair) {
        stream.write(149);
        writeValue(stream, ((PlatformIntPair) value).toList());
