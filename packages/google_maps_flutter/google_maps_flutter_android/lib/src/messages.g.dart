...
class PlatformIntPair {
  ...
  static PlatformIntPair decode(Object result) {
    result as List<Object?>;
    return PlatformIntPair(
      x: result[0]! as int,
      y: result[1]! as int,
    );
  }
...
class PlatformPolyline {
  ...
  PlatformIntPair? gradient;

  /// The texture image data for the polyline.
  PlatformBitmap? texture;
  ...
  static PlatformPolyline decode(Object result) {
    ...
    return PlatformPolyline(
      ...
      gradient: result[12] as PlatformIntPair?,
      texture: result[13] as PlatformBitmap?,
    );
  }
}
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is int) {
      ...
      buffer.putUint8(148);
      writeValue(buffer, value.encode());
    }    else if (value is PlatformIntPair) {
      buffer.putUint8(149);
      writeValue(buffer, value.encode());
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 149: 
        return PlatformIntPair.decode(readValue(buffer)!);
      case 150: 
