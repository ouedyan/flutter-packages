...
@interface FGMPlatformIntPair ()
+ (FGMPlatformIntPair *)fromList:(NSArray<id> *)list;
+ (nullable FGMPlatformIntPair *)nullableFromList:(NSArray<id> *)list;
- (NSArray<id> *)toList;
@end
...
@implementation FGMPlatformIntPair
+ (instancetype)makeWithX:(NSInteger )x
    y:(NSInteger )y {
  FGMPlatformIntPair* pigeonResult = [[FGMPlatformIntPair alloc] init];
  pigeonResult.x = x;
  pigeonResult.y = y;
  return pigeonResult;
}
+ (FGMPlatformIntPair *)fromList:(NSArray<id> *)list {
  FGMPlatformIntPair *pigeonResult = [[FGMPlatformIntPair alloc] init];
  pigeonResult.x = [GetNullableObjectAtIndex(list, 0) integerValue];
  pigeonResult.y = [GetNullableObjectAtIndex(list, 1) integerValue];
  return pigeonResult;
}
+ (nullable FGMPlatformIntPair *)nullableFromList:(NSArray<id> *)list {
  return (list) ? [FGMPlatformIntPair fromList:list] : nil;
}
- (NSArray<id> *)toList {
  return @[
    @(self.x),
...
+ (instancetype)makeWithPolylineId:(NSString *)polylineId
    ...
    zIndex:(NSInteger )zIndex
    gradient:(nullable FGMPlatformIntPair *)gradient
    texture:(nullable FGMPlatformBitmap *)texture {
...
+ (FGMPlatformPolyline *)fromList:(NSArray<id> *)list {
  ...
  pigeonResult.zIndex = [GetNullableObjectAtIndex(list, 9) integerValue];
  pigeonResult.gradient = GetNullableObjectAtIndex(list, 10);
  pigeonResult.texture = GetNullableObjectAtIndex(list, 11);
  return pigeonResult;
}
+ (nullable FGMPlatformPolyline *)nullableFromList:(NSArray<id> *)list {
...
- (nullable id)readValueOfType:(UInt8)type {
  switch (type) {
    ...
    case 145: 
      return [FGMPlatformIntPair fromList:[self readValue]];
    case 146: 
...
- (void)writeValue:(id)value {
  if ([value isKindOfClass:[FGMPlatformMapTypeBox class]]) {
    ...
    [self writeByte:144];
    [self writeValue:[value toList]];
  } else if ([value isKindOfClass:[FGMPlatformIntPair class]]) {
    [self writeByte:145];
    [self writeValue:[value toList]];
