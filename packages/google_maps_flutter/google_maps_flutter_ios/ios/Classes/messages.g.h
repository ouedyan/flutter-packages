...
@interface FGMPlatformIntPair : NSObject
/// `init` unavailable to enforce nonnull fields, see the `make` class method.
- (instancetype)init NS_UNAVAILABLE;
...
@property(nonatomic, strong, nullable) FGMPlatformIntPair * gradient;
/// The texture image data for the polyline.
@property(nonatomic, strong, nullable) FGMPlatformBitmap * texture;
@end
